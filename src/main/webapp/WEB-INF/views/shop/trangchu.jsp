...
<!-- Carousel Start -->
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class=" carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="text-uppercase display-4 text-white mb-3 animate__animated animate__fadeInDown">Unisex</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet
                                        lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp"
                                        href="#">MUA NGAY</a>
    ...
    <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span
                class="bg-secondary pr-3">Danh mục sản phẩm</span></h2>
        <div class="row px-xl-5 pb-3">
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4" >
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Category Name</h6>
                            <a href=""><small class="text-body bg-primary p-2">100+ Sản phẩm <i class="fas fa-angle-right"></i></small></a>
    ...
    <!-- Products Start -->
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Đề xuất</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
